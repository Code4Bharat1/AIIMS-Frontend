            ...
            <div className="flex flex-col justify-between md:w-[1400px] mx-auto xl:flex-row items-center gap-10 md:gap-50">
                <div className="flex-1 text-left text-md sm:text-md lg:text-2xl leading-relaxed">
                    <p>
                        ...
                        For grades 8 to 10, we focus on core subjects and scholarship exam preparation. Our science courses for grades 11 and 12 are
                        tailored to help students succeed in medical and engineering entrance exams.
                        With expert faculty, modern teaching methods, and a student-first approach, we provide a learning environment that fosters confidence,
                        clarity, and success.
                    </p>
                </div>
