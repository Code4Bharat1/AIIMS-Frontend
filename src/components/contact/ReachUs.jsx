...
const ReachUs = () => {
    ...
    return (
      <div className="flex flex-col lg:flex-row justify-end relative mt-10 mb-10 px-4 lg:px-0">
        <div className="hidden lg:flex bg-[#AFDDFF] h-[400px] w-[700px] rounded-l-full relative z-10 items-center justify-between px-10 pl-52">
          ...
          <div className="flex flex-col gap-9">
            ...
            <p className="text-md text-left">
              ...
              attention, regular parent-teacher meetings, top-notch teachers,
              and a leading curriculum. Experience the best in education with
              us.
            </p>
          </div>
        </div>
        ...
        <div className="relative w-full max-w-[500px] lg:absolute lg:w-[500px] lg:left-[calc(100%-1000px)] lg:top-1/2 lg:-translate-y-1/2 bg-[#2467C9] z-20 rounded-2xl flex flex-col justify-center items-center lg:items-start gap-8 p-4 lg:p-9 text-white overflow-hidden mx-auto lg:mx-0">
          <form
